CREATE TABLE test_bl.tmp_35094737_37_${acct} AS
...
CREATE TABLE test_bl.tmp_71927757_38_${acct} AS
...
from (select * from test_bl.tmp_35094737_37_${acct} union all select * from test_bl.tmp_71927757_38_${acct}) t1
group by t1.consume_area_id, t1.consume_area_name, t1.consume_parent_area_id, t1.consume_area_level;
test_bl
.
tmp_35094737_37_
${acct}
,test_bl.tmp_71927757_38_
${acct}