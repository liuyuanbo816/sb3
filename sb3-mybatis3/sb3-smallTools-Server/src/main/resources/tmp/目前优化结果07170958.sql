CREATE TABLE test_bl.tmp_82754088_37_${acct} AS
select tb15.consume_area_id,
       ...
       round(COALESCE((case
                           when tb16.nm_sum_fee_1694_momGrowth = 0 then 0
                                ...
                                tb16.nm_sum_fee_1694_momGrowth end), 0), 2)       as nm_sum_fee_1694_momGrowth,
       round(COALESCE((case
                           when tb17.nm_sum_fee_1694_yoy = 0 then 0
                           else (tb15.nm_sum_fee_1694_yoy - tb17.nm_sum_fee_1694_yoy) / tb17.nm_sum_fee_1694_yoy end),
       ...
       round(COALESCE((case
                           when tb17.nm_sum_fee_1694_yoyGrowth = 0 then 0
                                ...
                                tb17.nm_sum_fee_1694_yoyGrowth end), 0), 2)       as nm_sum_fee_1694_yoyGrowth,
       round(COALESCE((case
                           when tb18.nm_sum_fee_1694_yearEnd = 0 then 0
                           else (tb15.nm_sum_fee_1694_yearEnd - tb18.nm_sum_fee_1694_yearEnd) /
                                tb18.nm_sum_fee_1694_yearEnd end), 0), 2)         as nm_sum_fee_1694_yearEnd,
       round(COALESCE((case
                           when tb18.nm_sum_fee_1694_yearEndGrowth = 0 then 0
                                ...
                                tb18.nm_sum_fee_1694_yearEndGrowth end), 0), 2)   as nm_sum_fee_1694_yearEndGrowth
from (select tb2.area_id                                     as consume_area_id,
      ...
      group by tb2.area_id, tb2.area_name) tb15
         ...
         left join (select tb8.area_id                                     as consume_area_id,
                    ...
                    group by tb8.area_id, tb8.area_name) tb17
...
select tb33.consume_area_id,
       ...
       round(COALESCE((case
                           when tb34.nm_sum_fee_1694_momGrowth = 0 then 0
                                ...
                                tb34.nm_sum_fee_1694_momGrowth end), 0), 2)       as nm_sum_fee_1694_momGrowth,
       round(COALESCE((case
                           when tb35.nm_sum_fee_1694_yoy = 0 then 0
                           else (tb33.nm_sum_fee_1694_yoy - tb35.nm_sum_fee_1694_yoy) / tb35.nm_sum_fee_1694_yoy end),
                      0), 2)                                                      as nm_sum_fee_1694_yoy,
       round(COALESCE((case
                           when tb35.nm_sum_fee_1694_yoyGrowth = 0 then 0
                           else (tb33.nm_sum_fee_1694_yoyGrowth - tb35.nm_sum_fee_1694_yoyGrowth) /
                                tb35.nm_sum_fee_1694_yoyGrowth end), 0), 2)       as nm_sum_fee_1694_yoyGrowth,
       round(COALESCE((case
                           when tb36.nm_sum_fee_1694_yearEnd = 0 then 0
                           else (tb33.nm_sum_fee_1694_yearEnd - tb36.nm_sum_fee_1694_yearEnd) /
                                tb36.nm_sum_fee_1694_yearEnd end), 0), 2)         as nm_sum_fee_1694_yearEnd,
       round(COALESCE((case
                           when tb36.nm_sum_fee_1694_yearEndGrowth = 0 then 0
                                ...
                                tb36.nm_sum_fee_1694_yearEndGrowth end), 0), 2)   as nm_sum_fee_1694_yearEndGrowth
...
from (select * from test_bl.tmp_82754088_37_${acct} union all select * from test_bl.tmp_68945368_38_${acct}) t1
group by t1.consume_area_id, t1.consume_area_name, t1.consume_area_level;
test_bl
.
tmp_82754088_37_
${acct}
,test_bl.tmp_68945368_38_
${acct}