CREATE TABLE test_bl.tmp_46241698_37_${acct} AS
...
CREATE TABLE test_bl.tmp_47442610_38_${acct} AS
...
from (select tb20.sum_area_id                                 as consume_area_id,
             ...
             tb20.null                                        as consume_parent_area_id,
      ...
      group by tb20.sum_area_id, tb20.sum_area_name, tb20.null) tb33
         left join (select tb22.sum_area_id                                 as consume_area_id,
                           tb22.sum_area_name                               as consume_area_name,
                           tb22.null                                        as consume_parent_area_id,
                           1                                                as consume_area_level,
                           0                                                as nm_sum_fee_1694,
                    ...
                    group by tb22.sum_area_id, tb22.sum_area_name, tb22.null) tb34
         ...
         left join (select tb26.sum_area_id                                 as consume_area_id,
                           ...
                           tb26.null                                        as consume_parent_area_id,
                           1                                                as consume_area_level,
                           0                                                as nm_sum_fee_1694,
                           0                                                as nm_sum_fee_1694_pp,
                           0                                                as nm_sum_fee_1694_momGrowth,
                    ...
                    group by tb26.sum_area_id, tb26.sum_area_name, tb26.null) tb35
         ...
         left join (select tb30.sum_area_id                                 as consume_area_id,
                           ...
                           tb30.null                                        as consume_parent_area_id,
                           1                                                as consume_area_level,
                           0                                                as nm_sum_fee_1694,
                           0                                                as nm_sum_fee_1694_pp,
                           0                                                as nm_sum_fee_1694_momGrowth,
                    ...
                    group by tb30.sum_area_id, tb30.sum_area_name, tb30.null) tb36
...
from (select * from test_bl.tmp_46241698_37_${acct} union all select * from test_bl.tmp_47442610_38_${acct}) t1
group by t1.consume_area_id, t1.consume_area_name, t1.consume_parent_area_id, t1.consume_area_level;
test_bl
.
tmp_46241698_37_
${acct}
,test_bl.tmp_47442610_38_
${acct}