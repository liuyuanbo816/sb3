CREATE TABLE test_bl.tmp_34443323_37_${acct} AS
...
CREATE TABLE test_bl.tmp_28763804_38_${acct} AS
...
from (select * from test_bl.tmp_34443323_37_${acct} union all select * from test_bl.tmp_28763804_38_${acct}) t1
group by t1.consume_area_id, t1.consume_area_name, t1.consume_parent_area_id, t1.consume_area_level;
test_bl
.
tmp_34443323_37_
${acct}
,test_bl.tmp_28763804_38_
${acct}