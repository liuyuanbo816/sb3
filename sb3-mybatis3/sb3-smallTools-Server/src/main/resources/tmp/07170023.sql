CREATE TABLE test_bl.tmp_74724428_37_${acct} AS
select tb15.consume_area_id,
       ...
       round(COALESCE((case
                           when tb17.nm_sum_fee_1694_momGrowth = 0 then 0
                           else (tb15.nm_sum_fee_1694_momGrowth - tb17.nm_sum_fee_1694_momGrowth) /
                                tb17.nm_sum_fee_1694_momGrowth end), 0), 2)       as nm_sum_fee_1694_momGrowth,
       round(COALESCE((case
       ...
       round(COALESCE((case
                           when tb18.nm_sum_fee_1694_yoyGrowth = 0 then 0
                           else (tb15.nm_sum_fee_1694_yoyGrowth - tb18.nm_sum_fee_1694_yoyGrowth) /
                                tb18.nm_sum_fee_1694_yoyGrowth end), 0), 2)       as nm_sum_fee_1694_yoyGrowth,
       round(COALESCE((case
                           when tb16.nm_sum_fee_1694_yearEnd = 0 then 0
                           else (tb15.nm_sum_fee_1694_yearEnd - tb16.nm_sum_fee_1694_yearEnd) /
                                tb16.nm_sum_fee_1694_yearEnd end), 0), 2)         as nm_sum_fee_1694_yearEnd,
       round(COALESCE((case
...
CREATE TABLE test_bl.tmp_70199260_38_${acct} AS
select tb33.consume_area_id,
       ...
       round(COALESCE((case
                           when tb35.nm_sum_fee_1694_momGrowth = 0 then 0
                           else (tb33.nm_sum_fee_1694_momGrowth - tb35.nm_sum_fee_1694_momGrowth) /
                                tb35.nm_sum_fee_1694_momGrowth end), 0), 2)       as nm_sum_fee_1694_momGrowth,
       round(COALESCE((case
                      ...
                      0), 2)                                                      as nm_sum_fee_1694_yoy,
       round(COALESCE((case
                           when tb36.nm_sum_fee_1694_yoyGrowth = 0 then 0
                           else (tb33.nm_sum_fee_1694_yoyGrowth - tb36.nm_sum_fee_1694_yoyGrowth) /
                                tb36.nm_sum_fee_1694_yoyGrowth end), 0), 2)       as nm_sum_fee_1694_yoyGrowth,
       round(COALESCE((case
                           when tb34.nm_sum_fee_1694_yearEnd = 0 then 0
                           else (tb33.nm_sum_fee_1694_yearEnd - tb34.nm_sum_fee_1694_yearEnd) /
                                tb34.nm_sum_fee_1694_yearEnd end), 0), 2)         as nm_sum_fee_1694_yearEnd,
       round(COALESCE((case
...
from (select * from test_bl.tmp_74724428_37_${acct} union all select * from test_bl.tmp_70199260_38_${acct}) t1
group by t1.consume_area_id, t1.consume_area_name, t1.consume_area_level;
test_bl
.
tmp_74724428_37_
${acct}
,test_bl.tmp_70199260_38_
${acct}