CREATE TABLE test_bl.tmp_61940116_37_${acct} AS
...
CREATE TABLE test_bl.tmp_24588508_38_${acct} AS
...
from (select * from test_bl.tmp_61940116_37_${acct} union all select * from test_bl.tmp_24588508_38_${acct}) t1
group by t1.consume_area_id, t1.consume_area_name, t1.consume_area_level;
test_bl
.
tmp_61940116_37_
${acct}
,test_bl.tmp_24588508_38_
${acct}