CREATE TABLE test_bl.tmp_89577528_43_${acct} AS
...
CREATE TABLE test_bl.tmp_87924609_44_${acct} AS
...
from (select * from test_bl.tmp_89577528_43_${acct} union all select * from test_bl.tmp_87924609_44_${acct}) t1
group by t1.consume_area_id, t1.consume_area_name, t1.consume_area_level;
test_bl.tmp_89577528_43_${acct},test_bl.tmp_87924609_44_${acct}